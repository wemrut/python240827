...
for n in range(0,10):
        ...
        try:                       
                ...
                list = soup.find_all('td', attrs={'class':'subject'}) # key , value 로 가져옴
                #<td class="subject">
                #<a href="/board/view.php?table=bestofbest&amp;no=476433&amp;s_no=476433&amp;page=10" target="_top">펌) 1년동안 배달 10000건 가까이 보내고 느낀점.</a>
                #<span class="list_memo_count_span"> [15]</span>  <span style="margin-left:4px;"><img src="http://www.todayhumor.co.kr/board/images/list_icon_photo.gif" style="vertical-align:middle; margin-bottom:1px;"> 
